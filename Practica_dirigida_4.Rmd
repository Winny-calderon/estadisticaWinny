...
```{r}
head(data)[, c(3:5)]  #solo nos muestra las variables que hemos seleccionado, agregarlas al caluclo para agrupar los casos.
...
```{r}
grupos = pam(dist, 4, cluster.only = T) #Le decimos que cree dos grupos o cluster
...
También usar aggregate() para crear una nueva base que sean los resultados: Aggregate sirve para simplicar la info que tenemos en una base de datos de acuerdo a grupos que hemos identidificado.Creamos un nuevo objeto
```{r}
